...
export const ForgotPassword = () => {
  ...
  // let hideNumber = "+947"+ mobileNumber.substring(2,3) + "xxxx" + mobileNumber.substring(6,9)
      ...
      <div className="w-full fixed mt-[-69px] h-screen flex flex-col justify-center items-center bg-purple-100">
          <div className="flex flex-col w-full sm:w-[376px] h-1/3 justify-center items-center bg-white rounded-xl shadow-xl">
              ...
              {showRequest ? (
                ...
                <p className="font-semibold"><span className="font-normal text-sm">USER : </span>{currentUserName}</p>
                {/* <p className="mt-2 font-semibold"><span className="font-normal text-sm">NUMBER : </span>{hideNumber}</p> */}
        
                <button
                  className="sm:w-[100px] mt-4 text-white font-medium bg-purple-600 rounded-lg p-1 text-center flex items-center justify-center transition-all duration-100 hover:bg-purple-500 cursor-pointer"
                  onClick={requestOTP}
                >
                  Request OTP
                </button>
